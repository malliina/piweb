...
# Default-Stop:      0 1 6
# Short-Description: Start piweb at boot time
# Description:       Manages the services needed to run piweb
### END INIT INFO
#
# Startup script for piweb under *nix systems (it works under NT/cygwin too).
